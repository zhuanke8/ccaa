...
if [ $1 = 'cdn' ]
	...
	master_url='https://github.com/zhuanke8/ccaa/archive/master.zip'
	...
	filebrowser_url='https://github.com/filebrowser/filebrowser/releases/download/v2.21.1/linux-arm64-filebrowser.tar.gz'
	master_url='https://github.com/zhuanke8/ccaa/archive/master.zip'
...
#卸载
function uninstall(){
	wget -O ccaa-uninstall.sh https://raw.githubusercontent.com/zhuanke8/ccaa/master/uninstall.sh
